...
class PjitPartitioner(Partitioner):
  ...
  def __init__(
    ...
    if device_mesh is None:
      ...
      # lsp: 创建Mesh，但是这个函数出来的是无序的类似于[1, 3, 4, 7, 0, 2, 6]，如果这个无序Mesh传入host_local_array_to_global_array会报错
      if len(self._mesh_names) == 3: # lsp: 如果full shard，保留原始paxml的无序mesh id
