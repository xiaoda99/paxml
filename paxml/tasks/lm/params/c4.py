...
@experiment_registry.register
class PileLlamaMediumDense1x1DynamicAblateQK(PileLlamaMediumDense1x1Dynamic): #mqy
  ABLATE_DYNAMIC_DENSE_QKV = 'qk'

@experiment_registry.register
class PileLlamaMediumDense1x1DynamicAblateV(PileLlamaMediumDense1x1Dynamic): #mqy
  ABLATE_DYNAMIC_DENSE_QKV = 'v'
